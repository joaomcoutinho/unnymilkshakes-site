...
const menuItems: MenuItem[] = [
  {
    ...
    imageSrc: '/menu/milkshake-unny.png',
    filter: 'Shakes',
    flipText: '',
    featured: true,
  },
  {
    ...
    imageSrc: '/menu/cardapio_casquinha_e_cascao.png',
    filter: 'Sorvetes',
  ...
  },
  {
    ...
    imageSrc: '/menu/cardapio_topsundae.png',
    filter: 'Sobremesas',
  ...
  },
  {
    ...
    imageSrc: '/menu/cascao-trufado-unny.png',
    filter: 'Sorvetes',
  ...
  },
  {
    ...
    imageSrc: '/menu/na-colher-unny.png',
    filter: 'Sobremesas',
